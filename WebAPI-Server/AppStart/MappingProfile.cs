...
namespace WebAPI_Server.AppStart
{
    internal class MappingProfile : Profile
    {
        internal MappingProfile()
        {
            ...
            CreateMap<GetWebsiteInfoFromDomainParam, GetWebsiteInfoFromDomainParamViewModel>().ReverseMap();
            CreateMap<GetWebsiteInfoFromDomainModel, GetWebsiteInfoFromDomainViewModel>().ReverseMap();
        }
    }
}
