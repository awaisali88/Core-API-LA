...
namespace WebAPI_Server.Controllers
{
    ...
    public class BaseController : ControllerBase
    {
        ...
        /// <returns></returns>
        [ApiExplorerSettings(IgnoreApi = true)]
        protected virtual ObjectResult StatusCodeError(int statusCode, object error, string msg)
        {
            return base.StatusCode(statusCode, JsonConvert.SerializeObject(new ApiResponse(false, msg, null, error)));
        }
